<x-layouts.app>
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            <div class="relative overflow-hidden rounded-xl bg-zinc-900 border border-indigo-200 dark:border-indigo-700 px-8 py-5">
        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-indigo-200 dark:border-indigo-700">
